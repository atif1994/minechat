...
class DeleteLeadsAlertDialog extends StatelessWidget {
  final String title;
  ...
  const DeleteLeadsAlertDialog({
    super.key,
    this.title = 'Delete',
    this.message = 'Are you sure you want to delete? This action cannot be undone.',
  ...
  static Future<T?> show<T>({
    ...
    String title = 'Delete',
    String message = 'Are you sure you want to delete? This action cannot be undone.',
