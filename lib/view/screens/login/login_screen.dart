          ...
          children: [
            Positioned(
              ...
              child: Obx(() {
                ...
                final isDark = themeController.isDarkMode;
                final iconPath =
                    isDark ? AppAssets.darkMode : AppAssets.lightDart;
            ...
            Positioned(
                top: 30,
                right: 20,
                child: _iconWithOffset('camera', 28, isDark, Offset(0, 8))),
            Positioned(
                top: 100,
                left: 80,
                child: _iconWithOffset('messenger', 20, isDark, Offset(0, 8))),
            Positioned(
                top: 110,
                right: 80,
                child: _iconWithOffset('slack', 20, isDark, Offset(0, -6))),
            Positioned(
                top: 160,
                right: 120,
                child: _iconWithOffset('telegram', 20, isDark, Offset(0, -6))),
            Positioned(
                top: 220,
                left: 25,
                child: _iconWithOffset('instagram', 30, isDark, Offset(-4, 0))),
            Positioned(
                top: 270,
                right: 25,
                child: _iconWithOffset('discord', 20, isDark, Offset(4, 0))),
            Positioned(
                bottom: 140,
                left: 0,
                right: 0,
                child: _iconWithOffset('whatsapp', 28, isDark, Offset(0, -8))),
            Positioned(
                bottom: 100,
                left: 70,
                child: _iconWithOffset('slack', 24, isDark, Offset(0, 10))),
            Positioned(
                bottom: 100,
                right: 70,
                child: _iconWithOffset('viber', 24, isDark, Offset(0, 6))),
          ],
        );
      },
    );
