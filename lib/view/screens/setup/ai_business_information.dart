...
class AIBusinessInformation extends StatefulWidget {
  const AIBusinessInformation({super.key});

  @override
  State<AIBusinessInformation> createState() => _AIBusinessInformationState();
}

class _AIBusinessInformationState extends State<AIBusinessInformation> {
  ...
  Widget build(BuildContext context) {
    ...
    final knowledgeController = Get.find<AIKnowledgeController>();
